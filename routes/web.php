...
Route::get('/dashboard/pembelian/{pembelian_id}/edit', [PembelianController::class, 'index'])->name('pembelian.edit');
Route::get('/dashboard/pembelian/{pembelian_id}/update', [PembelianController::class, 'create'])->name('pembelian.store');
Route::post('/dashboard/pembelian/{pembelian_id}/delete', [PembelianController::class, 'store'])->name('pembelian.delete');
